            ...
            <div className="max-w-md w-full bg-slate-50/90 backdrop-blur-sm rounded-xl shadow-2xl overflow-hidden">
                <div className="text-center p-8 bg-slate-100/90 border-b border-slate-200">
                    ...
                    <h2 className="mt-6 text-center text-2xl font-bold text-gray-900">
                        {isSubmitted ? 'Check Your Email' : 'Admin Password Recovery'}
                    </h2>
                     {!isSubmitted && (
                    ...
                    {isSubmitted ? (
                        <div className="text-center">
                            <p className="text-gray-700">
                                If an admin account with the email <strong>{email}</strong> exists, you will receive a password reset link shortly.
                            </p>
